...
//Given a dataStructures.string expression representing an expression of fraction addition and subtraction, return the calculation result in dataStructures.string format.
//
...
//
//    Constraints:
//    The input dataStructures.string only contains '0' to '9', '/', '+' and '-'. So does the output.
