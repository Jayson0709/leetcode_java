...
//
//    You are given an array boxes, where boxes[i] = [ports_i, weighti], and three integers portsCount, maxBoxes, and maxWeight.
//
...
public class Q1687 {
    public static void main(String[] args) {
        ...
        int portsCount = Integer.parseInt(cin.nextLine().strip());
        int maxBoxes = Integer.parseInt(cin.nextLine().strip());
        int maxWeight = Integer.parseInt(cin.nextLine().strip());
        cin.close();
        System.out.println(boxDelivering(DataConversionMethods.convertIntArrArrayListTo2DArray(data),
            portsCount, maxBoxes, maxWeight));
    }
